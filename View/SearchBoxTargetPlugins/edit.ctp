...
<?php echo $this->Form->create('SearchBoxTargetPlugin'); ?>
	<fieldset>
		<legend><?php echo __('Edit Search Box Target Plugin'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('SearchBoxTargetPlugin.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('SearchBoxTargetPlugin.id'))); ?></li>
